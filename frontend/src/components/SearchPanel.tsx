    ...
    try {
      ...
      const body = mode === 'search'
        ...
        : {
            ...
            model: llmProvider === 'gemini' ? 'gemini-flash-lite-latest' : 'llama3.2:1b',
        ...
        <div className="llm-settings">
          <div className="setting-group">
            ...
            >
              ...
              <option value="ollama">Ollama Local (llama3.2:1b ⚡ 15s)</option>
            </select>
          </div>
          <div className="setting-group">
      ...
      {mode === 'rag' && ragAnswer && (
        <div className="rag-answer">
          ...
          <p className="model-info">
            <em>Generated by {llmProvider === 'gemini' ? 'gemini-flash-lite-latest (Google AI)' : 'llama3.2:1b (Ollama Local)'}</em>
          </p>
        </div>
      )}
