    ...
    try {
      ...
      const body = mode === 'search'
        ...
        : {
            ...
            model: llmProvider === 'gemini' ? 'gemini-flash-lite-latest' : 'gemma3:1b-it-qat',
      ...
      {mode === 'rag' && (
        <div className="llm-settings">
          <div className="setting-group">
            ...
            >
              <option value="gemini">Google AI Cloud (gemini-flash-lite ⚡ 8s)</option>
              <option value="ollama">Ollama Local (gemma3:1b 🐌 40s)</option>
            </select>
          </div>
          <div className="setting-group">
      ...
      {mode === 'rag' && ragAnswer && (
        <div className="rag-answer">
          ...
          <p className="model-info">
            <em>Generated by {llmProvider === 'gemini' ? 'gemini-flash-lite-latest (Google AI)' : 'gemma3:1b-it-qat (Ollama Local)'}</em>
          </p>
        </div>
      )}
